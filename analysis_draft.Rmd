...
```{r clean data}
# Load the dataset (assuming you have already read it into 'hiv_df') and delete those obs with missing or unrealistic sample_size.

hiv_df <- read.csv("high_quality_df.csv") |>
  janitor::clean_names() |>
  mutate(sample_size = as.numeric(sample_size)) |>
  filter(sample_size > 0 & !is.na(sample_size) )
